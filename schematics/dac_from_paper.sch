...
C {madvlsi/ammeter1.sym} 2250 70 0 0 {name=Vout}
...
C {devices/code.sym} -240 370 0 0 {name=SPICE only_toplevel=false value=".param W=32
.param L=4
.control
set wr_vecnames
set wr_singlescale
let code = 0
  while code < 128
    ...
    save all
    op
    wrdata ~/Documents/current-output-dac-vlsi/simulations/dac_paper_sim.txt i(Vmeas) i(vb0) i(vb1) i(vb2) i(vb3) i(vb4) i(vb5) i(vb6) i(Vout) i(Vdump)
    if code eq 0
      set appendwrite
...
C {madvlsi/gnd.sym} 2190 250 0 0 {name=l13 lab=GND}
C {madvlsi/vdd.sym} 2250 70 0 0 {name=l49 lab=VDD}
C {madvlsi/pmos3.sym} 1990 -80 0 0 {name=M53
L=\{L\}
W=\{W\}
body=VDD
nf=1
...
C {madvlsi/pmos3.sym} 1990 -160 0 0 {name=M54
L=\{L\}
W=\{W\}
body=VDD
nf=1
